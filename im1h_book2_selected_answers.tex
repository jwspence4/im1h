...
\item
	...
	\item $\overrightarrow{BC} = -\vec{u} + \vec{v}$ \\
		$\overrightarrow{MN} = -\frac{1}{2}\vec{u} + \frac{1}{2}\vec{v}$
		
	\item $\overline{BC}$ is twice as long as $\overline{MN}$, and the two segments are parallel.
...
\item
	...
	\item $(\frac{60}{13}, \frac{20}{13}, \frac{15}{13})$
