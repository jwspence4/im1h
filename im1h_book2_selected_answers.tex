...
\item Interior angles: $140 \degree$ \\
	$\angle PAN = 100 \degree$
	
\item --

\item $104 \degree$

\item One of them must be $90 \degree$.

\item It's the converse of the result in \#104.
...
\item
	...
	\item $\angle ANB = 84 \degree$ \\
		$\angle NBF = 6 \degree$
		
	\item $\angle ANB = 96 \degree$ \\
		$\angle NBF = 6 \degree$
...
\item Yes, it's regular.

\item

	\begin{enumerate}
	
	\item $\overline{GM} \cong \overline{MP}$ \\
		$\overline{BM} \cong \overline{MC}$
...
\item It's a parallelogram in both cases.

\item $\left[ 3, 1 -\frac{9}{4} \right]$
...
\item
	...
	\item $\frac{15}{2}, \frac{3}{2}\sqrt{73}, 3\sqrt{13}$
	
	\item $5, \sqrt{73}, 2\sqrt{13}$
	
	\end{enumerate}
	
\item Length of medians: $3\sqrt{3}$ \\
	Distance from centroid to vertices: $2\sqrt{3}$
...
\item
	...
	\item$(\frac{a + b + c}{3}, \frac{p + q + r}{3})$
...
\item Yes, $\triangle APQ$ is equilateral.

\item No, the proofs are identical.
...
\item
	...
	\item If a quadrilateral's diagonals are the same length, it is a rectangle.
...
\item
	...
	\item $\frac{1}{2} \vec{u} + \frac{1}{2} \vec{v}$
	
	\item $\frac{1}{3} \vec{v} + \frac{1}{3} \vec{u}$
	
	\item We just proved it with vectors.
...
\item 
	...
	\item The diagonals must have the same length.
	
	\item The diagonals must be perpendicular.
...
\item Yes, it's an isosceles trapezoid.
...
\item It must be a parallelogram.
...
\item 
	...
	\item $\frac{7}{2}, \frac{8}{2}, \frac{7}{2}$
